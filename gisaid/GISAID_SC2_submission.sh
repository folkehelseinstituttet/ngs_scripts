...
./covCLI upload --username "$username" --password "$password" --clientid "$clientid" --log YYYY-MM-DD_submission.log --metadata "$metadata_files" --fasta "$fasta_files" --frameshifts catch_novel --dateformat YYYYMMDD
