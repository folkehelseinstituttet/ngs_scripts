...
& "N:\Virologi\NGS\1-NGS-Analyser\8-Skript\1-GISAID\rsvCLI\rsvCLI.exe" upload --username $username `
...
$base_folder = "N:\Virologi\NGS\1-NGS-Analyser\1-Rutine\2-Resultater\RSV\10-GISAID"

# Create the folder with today's date appended
$today = Get-Date -Format "yyyy-MM-dd"
$folder_name = Join-Path -Path $base_folder -ChildPath "GISAID_RSV_submission_$today"
