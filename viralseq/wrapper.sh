...
nextflow run folkehelseinstituttet/viralseq/ -r v1.0.3 -profile server --input "$HOME/$RUN/samplesheet.csv" --outdir "$HOME/$RUN" --agens $AGENS -with-tower --platform "illumina" --skip_hcvglue false
