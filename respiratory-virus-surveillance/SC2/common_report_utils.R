...
plot_run_qc_by_run_colorgroup <- function(run_qc_df, title_txt, color_label = "Kategori") {
  if (is.null(run_qc_df) || nrow(run_qc_df) == 0) return(NULL)
...
plot_run_cov_by_run_colorgroup <- function(run_qc_df, title_txt, color_label = "Kategori") {
  if (is.null(run_qc_df) || nrow(run_qc_df) == 0) return(NULL)
